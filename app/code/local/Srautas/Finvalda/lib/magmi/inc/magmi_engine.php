...
require_once(dirname(__FILE__) . "/magmi_config.php");
require_once(dirname(__FILE__) . "/magmi_version.php");
require_once(dirname(__FILE__) . "/magmi_utils.php");
require_once(dirname(__FILE__) . "/magmi_statemanager.php");
require_once(dirname(__FILE__) . "/magmi_pluginhelper.php");
